/**
 * Generates templates.js from the template folder.
...
const outputPath = path.join(__dirname, '../src/templates.js');
...
const output = `/**
 * Auto-generated template files. Run: node scripts/generate-templates.js
 */
export const singleTemplates = ${JSON.stringify(singleTemplates, null, 2)};

export const multiTemplates = ${JSON.stringify(multiTemplates, null, 2)};
`;
