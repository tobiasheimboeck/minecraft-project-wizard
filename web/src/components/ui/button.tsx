...
const buttonVariants = cva(
  "cursor-pointer rounded-lg border text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary disabled:pointer-events-none disabled:opacity-50 inline-flex items-center justify-center font-mono",
  {
    variants: {
      variant: {
        default:
